...
const Notifications = () => {
    ...
    return (
        <div className="w-full flex flex-col gap-3 px-20">
            <Selector label="Game Updates" options={bool} value={notif.notifGameUpdates} onChange={(e)=>update({notif_game_updates:e})}/>
            <Selector label="Friend Requests" options={bool} value={notif.notifFriendReq} onChange={(e)=>update({notif_friend_req:e})}/>
        </div>
    );
}
